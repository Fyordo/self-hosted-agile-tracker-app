<template>
  <div class="profile-container">
    <UIImage :src="profileInfo.avatar" />
    <div class="profile-info">
      <div class="profile-input">
        <h2 class="input-margin">Username:</h2>
        <UIInput style="width: 500px" v-model="profileInfo.username" />
      </div>

      <div class="profile-input">
        <h2 class="input-margin">Login:</h2>
        <UIInput style="width: 500px" v-model="profileInfo.login" />
      </div>

      <div class="profile-input">
        <h2 class="input-margin">Avatar URL:</h2>
        <UIInput style="width: 500px" v-model="profileInfo.avatar" />
      </div>
